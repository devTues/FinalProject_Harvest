...
>>>>>>> 38c4247d03fa407d0d076d4b029b002c4b0e5818
...
<body>
<<<<<<< HEAD
<form action="${pageContext.request.contextPath }/create/createPro"  method="post" enctype="multipart/form-data">
		...
		<div class="proj_top">
			<div class="top_content1">
				...
				<div class="top_save_box">
					<input type="submit" value="임시저장" class="top_save"> <input type="submit" value="업로드" class="top_upload">
=======
...
>>>>>>> 38c4247d03fa407d0d076d4b029b002c4b0e5818
						...
						<div class="article_proj">
							...
							<div class="arti_cont5"><input type="text" name="title"></div>
						</div>
						<div class="article_proj">
							<div class="arti_tit6">상품 이름</div>
							<div class="arti_cont6"><input type="text" name="productMn"></div>
						</div>
						<div class="article_proj">
							<div class="arti_tit7">프로젝트 이미지</div>
							<div class="arti_cont7"><input multiple="multiple" type="file" name="img" /></div>
						</div>
						<div class="article_proj">
...
<<<<<<< HEAD
								<h3>프로젝트 소개</h3>
								<iframe src="${pageContext.request.contextPath }/creator/intro" width="550px" height="550px"> </iframe>
=======
							 <h3>프로젝트 소개</h3>
...
<<<<<<< HEAD
								<h3>프로젝트 예산</h3>
								<iframe src="${pageContext.request.contextPath }/creator/budget"  width="550px" height="550px"> </iframe>
							</div>
						</div>
						<div class="article_proj">
							<div class="arti_tit10">프로젝트 예산</div>
							<div class="arti_cont10">
								<h3>프로젝트 예산</h3>
								<iframe src="${pageContext.request.contextPath }/creator/schedule"  width="550px" height="550px"> </iframe>
=======
							 <h3>프로젝트 예산</h3>
								<iframe src="${pageContext.request.contextPath }/creator/editor">
								</iframe>
