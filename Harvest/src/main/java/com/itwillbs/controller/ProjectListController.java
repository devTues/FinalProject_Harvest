...
public class ProjectListController {
	...
	public String main(Model model, HttpServletRequest request, HttpSession session) {
		...
		param.put("GB", "POP");
		List<Map<String, Object>> popList = projectListService.getProjectList(param);
		model.addAttribute("getPopList", popList);

		param.put("GB", "NEW");
		List<Map<String, Object>> newList = projectListService.getProjectList(param);
		model.addAttribute("getNewList", newList);

		param.put("GB", "DEAD");
		List<Map<String, Object>> deadList = projectListService.getProjectList(param);
		model.addAttribute("getDeadList", deadList);

		param.put("GB", "EXP");
		List<Map<String, Object>> expList = projectListService.getProjectList(param);
		model.addAttribute("getExpList", expList);

		param.put("GB", "ALL");
		List<Map<String, Object>> allList = projectListService.getProjectList(param);
