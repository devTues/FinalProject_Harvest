						...
						<div class="card text-left">
							<div class="card-header p-0">
								...
								<div class="blog-media">
									<a href="${pageContext.request.contextPath }/projectInfo/projectInfo?idx=${getCategoryList.IDX }">
										<img src="${pageContext.request.contextPath }/resources/upload/${getCategoryList.IMG1 }" alt="" class="w-100">
									</a>
							...
							<div class="card-body px-0">
								<p class="my-2">${getCategoryList.CATEGORY } | ${getCategoryList.CRE_NM }</p>
								<input type="hidden" id="pjIdx_${getCategoryList.IDX }" value="${getCategoryList.IDX }">
								<a href="${pageContext.request.contextPath }/projectInfo/projectInfo?idx=${getCategoryList.IDX }">
									<h5 class="card-title mb-2">${getCategoryList.TITLE }</h5>
								</a>
								<span class="text-danger">${Math.round(getCategoryList.TOTAL_AMT / getCategoryList.targetAmt * 100)}%</span> <small><fmt:formatNumber value="${getCategoryList.TOTAL_AMT}" pattern="#,###"/>원</small>
								<div class="progress mt-2 mb-3">
									<div class="progress-bar bg-danger" role="progressbar" style="width: ${Math.round(getCategoryList.TOTAL_AMT / getCategoryList.TARGET_AMT * 100)}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
										...
										<fmt:parseDate value="${getCategoryList.end }" var="endDate" pattern="yyyy-MM-dd"/>
										<fmt:parseNumber value="${getCategoryList.end.time / (1000*60*60*24)}" integerOnly="true" var="end"></fmt:parseNumber>
