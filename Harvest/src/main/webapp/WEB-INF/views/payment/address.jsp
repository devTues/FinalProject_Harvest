...
<meta charset="UTF-8">
<title>배송지</title>
<link href="${pageContext.request.contextPath }/resources/harVest_css/payment/address.css" rel="stylesheet">
</head>
<body>
...
<form action="${pageContext.request.contextPath}/payment/addressPro" method="post">
...
// 				input += '<input type="radio" name="address" value="' + addrCnt + '" checked id="radd' + addrCnt + '"> ';
// 				input += '이름 : <input type="text" name="name"><br>';
// // 				input += '우편번호 : <input type="tsext" name="zipcode" id="zipcode" ><br>';
...
// opener.document.getElementById("phone").value=$("#phone").value;
</script>
<!-- <div id="addr"> -->
<!-- </div> -->
