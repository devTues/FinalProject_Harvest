				...
				<div class="col-md-12 text-center">
                    <h2 class="mb-4">비밀번호 찾기</h2>
		                <div class="form-group">
		                	<h4>고객님의 비밀번호를 알려드립니다.</h4>
		                </div>
		                	<p>비밀번호는 ${userDto.pass }입니다.</p>
		                <div class="form-group">
		        		</div>
		                <div class="col-md-12 mb-3">
		                    <input type="button" class="btn btn-block mybtn btn-brown tx-tfm" value="로그인 하러가기"
		                     onclick="location.href='${pageContext.request.contextPath }/user/login'"></button>
		                </div>
		                <hr>
	            </div> 
	       </div>
